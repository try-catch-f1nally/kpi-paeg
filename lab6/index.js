...
proceedVoting(elector4.login, elector4.password, elector4.token, 'candidate0');
proceedVoting(elector5.login, elector5.password, elector5.token, 'candidate0');
proceedVoting(elector1.login, elector1.password, elector1.token, 'candidate0');

electionCommittee.processBulletins();
